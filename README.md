...
Player X and Player O both type the column and row that they would like to choose. The board's positions are setup so that Index 0 is situated within the first column along with Row 0 (placed at the left-most side of the board). 

<img width="1320" alt="Screenshot 2025-01-19 at 1 27 51 PM" src="https://github.com/user-attachments/assets/3c70cf0c-ed56-4352-b3b3-9fb553ab9a4a" />

Player X wins! Womp womp for Player O. 
